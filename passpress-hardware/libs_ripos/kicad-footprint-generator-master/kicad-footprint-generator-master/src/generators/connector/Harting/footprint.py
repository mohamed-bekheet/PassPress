...
def create_footprints(spec: BaseSpec, generator_name: str) -> int:
    ...
    """
    import generators.connector.Harting.har_flexicon as hf
    spec_files = get_spec_file_names(generator_name, globs=["*.csv"])
    num_fps_generated = 0
    for spec_file in spec_files:
        num_fps_generated +=  hf.generate_all(generator_name, GLOBAL_CONFIG, spec_file)
