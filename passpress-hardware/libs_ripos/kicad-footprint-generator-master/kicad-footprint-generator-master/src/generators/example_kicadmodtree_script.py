...
if __name__ == '__main__':
    ...
    # create silscreen
    kicad_mod.append(Rectangle(start=[-2,-2], end=[5,2], layer='F.SilkS', width=0.15))

    # create courtyard
    kicad_mod.append(Rectangle(start=[-2.25,-2.25], end=[5.25,2.25], layer='F.CrtYd', width=0.05, offset=2))
